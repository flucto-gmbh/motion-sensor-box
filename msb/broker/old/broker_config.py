...
def parse_arguments() -> dict:
    ...
    arg_parser.add_argument(
        "--subscriber-ipc-port", help="IPC port used by zeroMQ", default=5555, type=int
    )

    arg_parser.add_argument(
        "--publisher-ipc-port", help="IPC port used by zeroMQ", default=5556, type=int
    )
    ...
    arg_parser.add_argument(
        "--profile", help="profile flag", default=False, action="store_true"
    )
